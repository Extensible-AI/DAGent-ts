...
var OllamaLLM_1 = require("../src/llm/OllamaLLM");
function testOllamaLLM() {
    return __awaiter(this, void 0, void 0, function () {
        var ollamaLLM, params, response, error_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ollamaLLM = new OllamaLLM_1.default();
                    params = {
                ...
                case 1:
                    _a.trys.push([1, 3, , 4]);
                    return [4 /*yield*/, ollamaLLM.call_tools(params)];
                case 2:
                    response = _a.sent();
                ...
                case 3:
                    error_1 = _a.sent();
                    console.error('Error calling OllamaLLM:', error_1);
                    return [3 /*break*/, 4];
